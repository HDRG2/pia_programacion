from tkinter import *
from Personas.agregar import agregar_empleado
from Personas.eliminar import eliminar_empleado
from Personas.ver_Empleado import ver_empleado
...
def empleados_menu(root, main_menu):
    ...
    button_ver_Empleado = Button(root,text="Ver empleado", command=lambda: Observar(root))
